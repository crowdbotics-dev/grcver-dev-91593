"""
Django settings for grcver_dev_91593 project.
...
ROOT_URLCONF = 'grcver_dev_91593.urls'
...
WSGI_APPLICATION = 'grcver_dev_91593.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grcver_dev_91593 API",
    "DESCRIPTION": "API documentation for grcver_dev_91593 App",
    "VERSION": "v1",
}
